...
exports.getAll = async function (fields,callback) {
    await connection.query('SELECT id_produk_keluar,nama_satwil,nama_jenis_produk_keluar,tanggal_produk_keluar,nomor_produk_keluar,kepada_produk_keluar,perihal_produk_keluar 	 FROM produk_keluar '+ 
